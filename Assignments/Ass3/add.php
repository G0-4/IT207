			...
			<div id="content">
				...
				<?php
                    ...
                    else
                    {
                        ...
                        $contactsFile = fopen('/home/cslavitt/helios_html/IT207/Assignments/Ass3/contactsList.txt', 'a') or die("File not Found");
						$checker = fwrite($contactsFile, $contact);

						if ($checker > 0)
						{
							echo "Contact succesfully added to list<br/>";
							echo "<a href='Ass3.php'>Return to Directory</a><br/>";
							fclose($contactsFile);	
						}
						else
						{
							echo "Contact failed to be added to list<br/>";
							echo "<a href='Ass3.php'>Return to Directory</a><br/>";
							fclose($contactsFile);	
						}
                    }
